...
\begin{itemize}
  ...
  \item Nghiên cứu, huấn luyện và đánh giá so sánh hiệu năng của 5 mô hình phân vùng thực thể hiện đại (Mask R-CNN, YOLO26-seg trung bình, RF-DETR, MobileSAM, Mask2Former) trên tập dữ liệu đã xây dựng.
