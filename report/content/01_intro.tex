...
\begin{itemize}
    ...
    \item \textbf{Phạm vi}: 8 lớp nhãn được chia đều cho hai đối tượng cây trồng chính:
          \begin{itemize}
              \item Lúa:\texttt{Healthy} (Khỏe mạnh), \texttt{BrownSpot} (Đốm nâu), \texttt{Hispa} (Sâu gai), \texttt{LeafBlast} (Đạo ôn).
              \item Cà phê:\texttt{AlgalLeafSpot} (Đốm lá tảo), \texttt{LeafMiner} (Sâu vẽ bùa), \texttt{PowderyMildew} (Phấn trắng), \texttt{Rust} (Gỉ sắt).
          \end{itemize}
\end{itemize}z
