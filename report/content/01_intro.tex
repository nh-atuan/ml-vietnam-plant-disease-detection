...
\begin{itemize}
    ...
    \item \textbf{Phạm vi:} 8 lớp nhãn gồm \texttt{Healthy}, \texttt{BrownSpot}, \texttt{Hispa}, \texttt{LeafBlast} (lúa) và \texttt{LeafMiner}, \texttt{PowderyMildew}, \texttt{Rust}, \texttt{AlgalLeafSpot} (cà phê).
\end{itemize}
