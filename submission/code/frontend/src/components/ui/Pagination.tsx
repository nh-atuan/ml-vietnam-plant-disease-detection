...
export default function Pagination({ page, totalPages, isLoading = false, onPageChange }: PaginationProps) {
  ...
  return (
    <nav className="flex flex-col gap-3 border-t border-surface-border pt-4 sm:flex-row sm:items-center sm:justify-between" aria-label="Phân trang lịch sử chẩn đoán">
