...
export default function LoadingSpinner() {
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4 space-y-3 text-center" role="status" aria-live="polite">
      ...
      <p className="text-sm font-semibold text-foreground">Đang xử lý phân tích...</p>
      <p className="text-xs text-claude-muted">Mô hình AI đang chẩn đoán hình ảnh lá cây</p>
    </div>
  );
}
